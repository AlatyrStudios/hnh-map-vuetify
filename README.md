...
> docker build -t "mapper" https://github.com/AlatyrStudios/hnh-map-vuetify.git

> docker run -v /srv/hnh-map:/map -p 8080:8080 mapper:latest
...
Run it via whatever you feel like, it's listening internally on port 8080 and expects `/map` to be mounted as a volume(database and images are stored here).
